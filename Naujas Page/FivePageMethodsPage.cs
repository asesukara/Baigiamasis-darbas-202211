...
namespace BaigiamasisDarbas.Page
{
    public class FivePageMethodsPage : BaseDriver
    {
        ...
        public void GoPayseraElement()
        {
            payseraElement.Click();
        }
        public void GoSebElement()
        {
            sebElement.Click();
        }
        public void GoMasterCardElement()
        {
            mastercardElement.Click();
        }
        public void GoVisaElement()
        {
            visaElement.Click();
        }
        public void GoSwedbankElement()
        {
            swedbankElement.Click();
        }
        public void GetAllFiveList()
        {
            fivePayMethods.Count();
        }
        public void CompareResultFivePayMethods()
        {
