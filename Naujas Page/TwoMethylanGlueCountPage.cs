...
namespace BaigiamasisDarbas.Page
{
    public class TwoMethylanGlueCountPage : BaseDriver
    {
        ...
        public void CloseAllPopupButton()
        {
        ...
        public void MethylanWoodchipElement2(string CounTwo)
        {
            methylanWoodchipElement2.Click();
        }
        public void MethylanVinylAndSpezial1Element(string CountOne)
        {
            methylanVinylAndSpezial1Element.Click();
        }
        public void CompareTwoCountResult()
        {
            Assert.AreNotSame(methylanWoodchipElement2, methylanVinylAndSpezial1Element, "are equal");
        }
        public void GetIntTwoCountResult()
        {
            string CountTwo = "2";
            string CountOne = "1";
            int x1, x2;
            bool woodchipElementCount = int.TryParse(CountTwo, out x1);

            bool methylanVinylCount = int.TryParse(CountOne, out x2);
